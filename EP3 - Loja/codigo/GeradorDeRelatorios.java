...
public class GeradorDeRelatorios {
	...
	public static void main(String [] args) {
		...
		gdr = new GeradorDeRelatorios(produtos, ALG_INSERTIONSORT, CRIT_PRECO_CRESC, FORMATO_PADRAO | FORMATO_NEGRITO |  FORMATO_ITALICO, FILTRO_CATEGORIA_IGUAL_A, "Livros"); 
